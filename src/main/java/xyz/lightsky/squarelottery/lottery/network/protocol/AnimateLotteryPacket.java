package xyz.lightsky.squarelottery.lottery.network.protocol;
...
@Getter
@Setter
public class AnimateLotteryPacket extends DataPacket {
    ...
    public void encode() {
        ...
        this.putLFloat(this.blendOutTime == 0F ? 1F : this.blendOutTime);
